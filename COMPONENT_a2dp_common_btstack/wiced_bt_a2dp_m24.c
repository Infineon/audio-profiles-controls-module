...
#if (WICED_BT_A2DP_SINK_CO_M24_SUPPORT == TRUE || WICED_BT_A2DP_SOURCE_CO_M24_SUPPORT == TRUE)
/******************************************************************************
*
...
#endif // (WICED_BT_A2DP_SINK_CO_M24_SUPPORT == TRUE || WICED_BT_A2DP_SOURCE_CO_M24_SUPPORT == TRUE)
